...
def brighten(cur_path, is_gamma=True, method='Ying_CAIP', gamma=1.0, print_timespan=False):
...
if __name__ == '__main__':
	brighten(os.getcwd() + "\\dataset\data-avi", is_gamma=False, method='lime', print_timespan=True)
